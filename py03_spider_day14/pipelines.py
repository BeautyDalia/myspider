...
class MysqlPipeline(object):
    def __init__(self):
        self.conn = pymysql.connect('47.94.220.92','root','123456','spider',charset='utf8')
...
class LagouMysqlPipeline(MysqlPipeline):
    def process_item(self,item, spider):
        if spider.name == 'lagou':
            sql = 'insert into lagou(url,pname,smoney,emoney,location,syear,eyear,degree,ptype,tags,date_pub,advantage,jobdesc,jobaddr,company,crawl_time) ' \
